(function(){
  ...
  // Use constants from shared module if available, otherwise use local copy
      ...
      groups.each(function(d,i){
        ...
        g.style('cursor','pointer')
          ...
          .on('mouseenter', function(evt){
            try {
              if (isDistrict && self._handlers.district && typeof self._handlers.district.mouseenter==='function') self._handlers.district.mouseenter(evt, d.unit);
              else if (self._handlers.state && typeof self._handlers.state.mouseenter==='function') self._handlers.state.mouseenter(evt, d.unit.replace(/-AL$/,''));
            } catch(e){}
          })
          .on('mousemove', function(evt){
            try {
              if (self._handlers.state && typeof self._handlers.state.mousemove==='function') self._handlers.state.mousemove(evt);
            } catch(e){}
          })
          .on('mouseleave', function(evt){
            try {
              if (self._handlers.state && typeof self._handlers.state.mouseleave==='function') self._handlers.state.mouseleave(evt);
            } catch(e){}
          });
      });
