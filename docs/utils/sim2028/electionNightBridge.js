 ...
 * fraction of all voters going third-party), and a siphon lean (0..1) saying
 * how much of that share comes out of D's pool vs R's pool — 0 = entirely
 * from R (spoils R), 1 = entirely from D (spoils D), 0.5 = symmetric (margin
...
export function synthesizeVotesThreeWay(twoPartyMargin, thirdShare, siphonLean, totalVotes) {
  ...
  const oVotes = Math.round(total * oShareFinal);
...
export default { installElectionNight, buildRows, synthesizeVotes, synthesizeVotesThreeWay, YEAR };
