...
def safe_int(x):
    try:
        ...
        print(f"Warning: could not convert to int: {x}")
        return 0
...
def safe_float(x):
    try:
        ...
        print(f"Warning: could not convert to float: {x}")
        return 0.0
...
def main():
    ...
    # write CSV
    fieldnames = [
    'year', 'abbr', 'D_votes', 'R_votes', 'T_votes', 'total_votes', 'electoral_votes', 'color',
