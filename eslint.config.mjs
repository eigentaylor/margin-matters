...
export default defineConfig([
  { files: ["**/*.{js,mjs,cjs,ts,mts,cts}"], plugins: { js }, extends: ["js/recommended"], languageOptions: { globals: { ...globals.browser, d3: 'readonly', topojson: 'readonly' } }, rules: { 'no-empty': 'off', 'no-unused-vars': 'off' } },
